...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 relative overflow-hidden min-h-screen">
      ...
      <div className="absolute inset-0">
        ...
        {isSubmitted && (
          <motion.div
            className="absolute top-40 right-40 w-20 h-20 bg-gradient-to-r from-green-200 to-blue-200 rounded-full opacity-20"
            animate={{
              scale: [1, 1.4, 1],
              rotate: [0, 180, 360],
              x: [0, 40, 0],
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            {isSubmitted ? 'Thank You!' : 'Get Your Dream Project'}
          </motion.h2>
          <motion.p 
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-white/20 text-center">
              ...
              <motion.button
                onClick={() => {
                  ...
                  trackButtonClick('Submit Another Inquiry', 'Contact Success');
                }}
